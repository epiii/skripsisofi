...
switch($_GET[act]){
  ...
  default:
    ...
    $tampil=mysqli_query($con,"SELECT * FROM download ORDER BY id_download DESC LIMIT $posisi,$batas");
  ...
  case "editdownload":
    $edit = mysqli_query($con,"SELECT * FROM download WHERE id_download='$_GET[id]'");
