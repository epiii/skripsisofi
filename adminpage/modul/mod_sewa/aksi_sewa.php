...
if ($module=='order' AND $act=='update'){
   ...
   if ($_POST[status_order]=='Lunas'){ 
      ...
      mysqli_query($con,"UPDATE produk,orders_detail SET produk.dibeli=produk.dibeli+orders_detail.jumlah WHERE produk.id_produk=orders_detail.id_produk and orders_detail.id_orders='$_POST[id]'");

      // Update status order
      mysqli_query($con,"UPDATE orders SET status_order='$_POST[status_order]' where id_orders='$_POST[id]'");
